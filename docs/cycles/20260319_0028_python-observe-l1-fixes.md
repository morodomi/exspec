...
### DISCOVERED
- [ ] PY-STEM-10: `___triple.py` の動作を確定するテスト (correctness review 指摘)
- [ ] PY-SRCLAYOUT-01/02 に `strategy` assertion 追加 (test review 指摘)
- [ ] integration テスト boilerplate のヘルパー抽出 (test review 指摘)
